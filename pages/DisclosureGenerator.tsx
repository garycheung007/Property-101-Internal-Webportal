...
const DisclosureGenerator: React.FC = () => {
  ...
  const buildMergeData = (): Record<string, string> => {
    ...
    return {
      ...
      Proceedings_pending_against_the_body_cor: vals.proceedingsPendingAgainst,
      Proceedings_initiated_by_the_body_corpor: vals.proceedingsInitiatedBy,
      Proceedings_intended_to_be_initiated_by_: vals.proceedingsIntendedToInitiate,
      Written_claim_by_the_body_corporate: vals.writtenClaimByBC,
